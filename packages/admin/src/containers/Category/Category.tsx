...
export default function Category() {
  ...
  React.useEffect(() => {
    CategoryTypeDataService.getAll()
      .then(response => {
        setCategorySelectOptions(response.data);
  ...
  React.useEffect(() => {
    CategoryDataService.findAll(category.length ? category[0].value : '', search)
      .then(response => {
  ...
  function handleSearch(event) {
    ...
    setSearch(value);
    CategoryDataService.findAll(category.length ? category[0].value : '', value)
      .then(response => {
        setCategories(response.data);
        console.log(response.data);
      })
  ...
  function handleCategory({ value }) {
    setCategory(value);
    if (value.length) {
      CategoryDataService.findAll(value[0].value, search)
        .then(response => {
          setCategories(response.data);
          console.log(response.data);
        })
      ...
      CategoryDataService.findAll('', search)
        .then(response => {
          setCategories(response.data);
          console.log(response.data);
        })
